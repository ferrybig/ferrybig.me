...
gulp.task('watch', function () {
	gulp.watch('src/static/sass/**/*.scss', ['watch:trigger:scss']);
	gulp.watch('src/static/js/**/*.js', ['watch:trigger:js']);
	gulp.watch('src/dynamic/**/*.php', ['watch:trigger:php']);
	gulp.watch('public/*.html', ['watch:trigger:html']);
...
gulp.task('watch:trigger:html', function (cb) {
	runSequence('serve:reload:html', cb);
});
gulp.task('watch:trigger:php', function (cb) {
	runSequence('content', 'serve:reload:html', cb);
});
